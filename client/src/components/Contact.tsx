 ...
 * - Social link hover micro-animations
  ...
  const socialLinks = [
    {
      ...
      color: 'hover:text-red-600 hover:border-red-200 hover:bg-red-50/50',
    },
    {
      icon: Instagram,
      label: 'Instagram',
      url: 'https://www.instagram.com/jit.kumar.207?igsh=Y2w3djNjODloZTN1',
      color: 'hover:text-pink-600 hover:border-pink-200 hover:bg-pink-50/50',
    },
    {
      icon: MessageCircle,
      label: 'WhatsApp',
      url: 'https://wa.me/918927532911',
      color: 'hover:text-green-500 hover:border-green-200 hover:bg-green-50/50',
    },
  ];
          ...
          <motion.div variants={itemVariants}>
            <GlassmorphicCard delay={0}>
              <div className="p-6 md:p-8">
                <h3 className="text-xl md:text-2xl font-bold text-slate-900 mb-6">Send me a message</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <motion.div custom={0} variants={formFieldVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-white/50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-transparent transition-all duration-300 disabled:opacity-50"
                  ...
                  <motion.div custom={2} variants={formFieldVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
                    ...
                    <textarea
                      ...
                      disabled={isSubmitting}
                      rows={5}
                      className="w-full px-4 py-3 bg-white/50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-transparent transition-all duration-300 resize-none disabled:opacity-50"
                  ...
                  <motion.button
                    type="submit"
                    disabled={isSubmitting}
                    whileHover={{ scale: 1.02, boxShadow: '0 8px 25px rgba(99, 102, 241, 0.25)' }}
                    whileTap={{ scale: 0.98 }}
                    className="w-full px-6 py-3.5 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-semibold rounded-lg transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
                      <>
                        <motion.div
                  ...
                  {socialLinks.map((social, index) => {
                    ...
                    return (
                      <motion.a
                        ...
                        whileTap={{ scale: 0.97 }}
                        className={`flex items-center justify-center gap-2 p-4 bg-white/50 border border-slate-200 rounded-lg transition-all duration-300 ${social.color}`}
                      >
              ...
              <div className="p-6 md:p-8">
                <div className="flex items-start gap-3">
                  <motion.div
                    ...
                    className="w-3 h-3 bg-green-500 rounded-full mt-2"
                  />
                  <div>
